...
<body>
	<section class="shop">
		<div class="filter-sec">
			<h3>Categories</h3>
			<ul class="filters">
				<li><a href="/mshop/allcategories">All Products</a></li>	
				<c:forEach var="male" items="${male}">
					<li><a href="/mshop/bycategory?id=${male.getId()}">${male.getCategoryName()}</a></li>
				</c:forEach>
			</ul>
		</div>
		<div class="product-view-sec">
		<c:forEach var="products" items="${products}">
			<a href="/mshop/product/view?id=${products.getProductId()}">
